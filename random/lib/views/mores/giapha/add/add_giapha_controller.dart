...
import 'package:match_manager/models/db/person_db.dart';
...
class AddGiaphaController extends GetxController with ShareMixin {
  PersonDB model = PersonDB(DateTime.now().millisecondsSinceEpoch);
